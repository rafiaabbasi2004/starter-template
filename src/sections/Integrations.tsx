...
export default function Integrations() {
    ...
    <section className="py-24 overflow-hidden">
        <div className="container">
            <div className="grid lg:grid-cols-2 items-center lg:items-stretch lg:gap-16">
                <div>
                <Tag>Integrations</Tag>
                <h2 className="text-6xl font-medium mt-6">Plays well with <span className="text-lime-400">others</span></h2>
                <p className="text-white/50 mt-4 text-lg">
                layers seemlessly connects with your fav too easy to plug into whatever
                </p>
                </div>
              
            <div> 
                <div className="h-[400px] lg:h-[800px] mt-8 lg:mt-0 overflow-hidden grid md:grid-cols-2 gap-4 integration-mask ">
                    <IntegrationCol integrations={integrations} />
                    <IntegrationCol integrations={integrations.slice().reverse()} reversed className="hidden md:flex" />
                </div>
