    ...
    return(
        <section className="py-24">
            <div className="container">
                ...
                <h2 
                className="text-6xl font-medium mt-6 text-center max-w-xl mx-auto">
                    Questions? we got <span className="text-lime-400">answers</span></h2>
                        ...
                        <div key={faq.question} className="bg-neutral-900 rounded-2xl border border-white/10 p-6 ">
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    aria-label={openIndex === faqIndex ? "Close answer" : "Open answer"}
                                    className="focus:outline-none"
                                    type="button"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={twMerge("feather feather-plus text-lime-400 flex-shrink-0 transition-transform duration-200", openIndex === faqIndex && "rotate-45")}>
                                        <line x1="12" y1="5" x2="12" y2="19"></line>
                                        <line x1="5" y1="12" x2="19" y2="12"></line>
                                    </svg>
                                </button>
                            </div>
                            <div className={twMerge("mt-6 transition-all duration-200", openIndex !== faqIndex && "hidden")}>
